...
<body>
	...
	<a href="./RequestWebInfo.jsp?eng=Hello&han=안녕&page=2&set=data">Get방식 전송</a>
	<br/>
	...
	<form method="post" action="RequestParameter.jsp">
		...
		성별 : <input type="radio" name="gerder" value="man" />남자
		<input type="radio" name="gerder" value="woman" checked="checked"/>여자<br/>
